...
class ProfileActivity : AppCompatActivity() {
            ...
            GlobalScope.launch {
                ...
                try {
                    ...
                    runOnUiThread { // Run in foreground
                        Toast.makeText(this@ProfileActivity, OAuthConstants.UPDATE_SUCCESS, Toast.LENGTH_LONG).show()
                    }
                } catch (e: Exception){
                    runOnUiThread { // Run in foreground
                        Toast.makeText(this@ProfileActivity, OAuthConstants.UPDATE_FAILED, Toast.LENGTH_LONG).show()
                    }
                }
    ...
    private suspend fun updateDescription(): User?{
        return TwitchApiService(Network.createHttpClient(this)).updateUserDescription(userDescriptionEditText.text.toString())
    }
